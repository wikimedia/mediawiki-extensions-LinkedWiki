...
class SpecialSparqlQuery extends SpecialPage {
    ...
    public function execute($par = null) {
        ...
        if ($query == "" || $output == "save" || $output == "wiki") {
            ...
            $wgOut->addHTML(wfMessage('linkedwiki-specialsparqlquery_endpointsparql')->text() . " : <input type='text' name='endpoint' size='50' value='" . $endpoint . " '>");
...
//-->
            ...
            $wgOut->addHTML("<input type='button' value='" . wfMessage('linkedwiki-specialsparqlquery_sendquery')->text() . "'  onClick='validAndSendQuery();' />");
            ...
            if ($queryWithoutPrefix != "") {
                ...
                if ($errs) {
                    ...
                    //						//SparqlParser::simple( $querySparqlWiki,$endpoint ,$classHeaders = '',$headers = '', $debug = null)
                    $arr = SparqlParser::simpleHTML($query, $endpoint, '', '', null);
                    $wgOut->addHTML($arr[0]);
